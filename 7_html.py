...
<ul class="jambotron mt-5">
    ...
    <div>
        ...
        <li>
            <a href="lohitbadiger.heroku" id="lohit">This is my personal web</a>
        <li>

        <li>
            <a href="gooele.heroku" id="google">This is my search engine</a>
        <li>
...
# if i want to scrape only the smal portions of the data()
print("''''''''''''''''''''''''''''''''''")

print('soup_take.get_text(): ', soup_take.get_text())

print("-"*20+'soupstainer' +"-"*20)
